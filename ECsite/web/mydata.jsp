            ...
            <div class="container-fluid">
                <div class="col-xs-6 col-xs-offset-3">
                    ...
                    <table class="container-fluid table" style="word-break: break-all;">
                        <tr><td class="text-right" style="width: 120px;">名前</td><td style="width: 230px;">${sessionScope.login.getName()}</td></tr>
                    ...
                    <table class="container-fluid table" >
                        ...
                        <tr><td colspan="2" class="text-center"><a href="mydelete.jsp">退会申請</a></td></tr></table>     
                    </div>
                </div>
            </div>
        </div>
